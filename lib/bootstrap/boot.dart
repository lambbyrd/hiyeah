...
_setup() async {
  ...
  try {
    // ClerkService initialization is handled via the ClerkAuth widget in AuthPage
    // This ensures Clerk is initialized when needed
    NyLogger.debug('ClerkService ready for initialization');
  } catch (e) {
    NyLogger.debug('ClerkService setup error: $e');
  }
